...
| ----------- | ------------------ | --------- | ---------- | ------------ | ------------- | ------------- | ------------------- |
| 1           | Don't Care         | 0         | 0x8        | Don't Care   | 0             | 0             | 0                   |
...
| Instruction | Address Bus        | RAM Write | ALU Opcode | Input Select | Output Select | Output Enable | Save Core Selection |
| ----------- | ------------------ | --------- | ---------- | ------------ | ------------- | ------------- | ------------------- |
| 1           | <Address>          | 0         | 0x0        | Don't Care   | 0             | 0             | 0                   |
...
| Instruction | Address Bus        | RAM Write | ALU Opcode | Input Select | Output Select | Output Enable | Save Core Selection |
| ----------- | ------------------ | --------- | ---------- | ------------ | ------------- | ------------- | ------------------- |
| 1-64        | Don't Care         | 0         | 0x3        | Don't Care   | 0             | 0             | 0                   |
...
| Instruction | Address Bus        | RAM Write | ALU Opcode | Input Select | Output Select | Output Enable | Save Core Selection |
| ----------- | ------------------ | --------- | ---------- | ------------ | ------------- | ------------- | ------------------- |
| 1           | Don't Care         | 0         | 0x6        | 01           | 0             | 0             | 0                   |
| 2           | \<Address> * 4 + 3 | 0         | 0x1 or 0x5 | Don't Care   | 0             | 0             | 0                   |
| 3           | Don't Care         | 0         | 0x6        | 01           | 0             | 0             | 0                   |
| 4           | \<Address> * 4 + 2 | 0         | 0x1 or 0x5 | Don't Care   | 0             | 0             | 0                   |
| 5           | Don't Care         | 0         | 0x6        | 01           | 0             | 0             | 0                   |
| 6           | \<Address> * 4 + 1 | 0         | 0x1 or 0x5 | Don't Care   | 0             | 0             | 0                   |
| 7           | Don't Care         | 0         | 0x6        | 01           | 0             | 0             | 0                   |
| 8           | \<Address> * 4     | 0         | 0x1 or 0x5 | Don't Care   | 0             | 0             | 0                   |
...
| 1             | \<Address> * 4 + int(\<Bits> / 16)           | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
| 1             | \<Address> * 4 + (3 + int(\<Bits> / 16) % 4) | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
| 1             | \<Address> * 4 + (2 + int(\<Bits> / 16) % 4) | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
| 1             | \<Address> * 4 + (1 + int(\<Bits> / 16) % 4) | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
...
| Instruction   | Address Bus            | RAM Write | ALU Opcode | Input Select | Output Select | Output Enable | Save Core Selection |
| ------------- | ---------------------- | --------- | ---------- | ------------ | ------------- | ------------- | ------------------- |
| 1             | \<Address> * 4         | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
| 2             | \<Address> * 4 + 3     | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
| 3             | \<Address> * 4 + 2     | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
| 4             | \<Address> * 4 + 1     | 1         | 0x2        | Don't Care   | Don't Care    | 0             | 0                   |
...
| Instruction   | Address Bus            | RAM Write | ALU Opcode | Input Select | Output Select | Output Enable | Save Core Selection |
| ------------- | ---------------------- | --------- | ---------- | ------------ | ------------- | ------------- | ------------------- |
| 1             | \<Address> * 4         | 1         | 0xE        | Don't Care   | Don't Care    | 0             | 0                   |
...
| 2           | Don't Care         | 0         | 0x6        | Don't Care   | 0             | 0             | 0                   |
| 3           | \<Address> * 4 + 3 | 1         | 0xB        | Don't Care   | 0             | 0             | 0                   |
| 4           | Don't Care         | 0         | 0x6        | Don't Care   | 0             | 0             | 0                   |
| 5           | \<Address> * 4 + 2 | 1         | 0xB        | Don't Care   | 0             | 0             | 0                   |
| 6           | Don't Care         | 0         | 0x6        | Don't Care   | 0             | 0             | 0                   |
| 7           | \<Address> * 4 + 1 | 1         | 0xB        | Don't Care   | 0             | 0             | 0                   |
| 8           | Don't Care         | 0         | 0x6        | Don't Care   | 0             | 0             | 0                   |
...
| Instruction | Address Bus        | RAM Write | ALU Opcode | Input Select | Output Select | Output Enable | Save Core Selection |
| ----------- | ------------------ | --------- | ---------- | ------------ | ------------- | ------------- | ------------------- |
| 1           | Don't Care         | 0         | 0x7        | Don't Care   | 0             | 0             | 0                   |
