...
#include "Vincrement_nonce_state_machine.h"
#include "verilated.h"
#include "test.h"
...
int main(int argc, char **argv, char **env) {
  ...
  Vincrement_nonce_state_machine* top = new Vincrement_nonce_state_machine;
  top->start_i = 0;
  top->eval();
  ...
  test.check("global_command is 1", i.global_command == 1);
