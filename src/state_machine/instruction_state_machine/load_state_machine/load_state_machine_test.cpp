...
int main(int argc, char **argv, char **env) {
  ...
  Vload_state_machine* top = new Vload_state_machine;
  top->clk_i = 0;
  top->rst_i = 1;
  top->address_i = 12;
  top->secondary_i = 0;
  ...
  test.check("alu_opcode is 0x6", i.alu_opcode == 0x6);
  ...
  test.check("save_core_selection is 0", i.save_core_selection == 0);
  test.check("ram_write_bit is 0", i.ram_write_bit == 0);
  test.check("address is 0", i.address == 0);
  test.check("input_select is 1", i.input_select == 1);
  test.check("output_select is 0", i.output_select == 0);
  test.check("output_enable is 0", i.output_enable == 0);
  test.check("alu_opcode is 0x1", i.alu_opcode == 0x1);
  test.check("global_command is 0", i.global_command == 0);
  test.check("Not done", top->done_o == 0);
  ...
  test.check("alu_opcode is 0x1", i.alu_opcode == 0x1);
  test.check("global_command is 0", i.global_command == 0);
  test.check("Not done", top->done_o == 1);
  ...
  test.check("output_select is 0", i.output_select == 0);
  test.check("output_enable is 0", i.output_enable == 0);
  test.check("alu_opcode is 0x5", i.alu_opcode == 0x5);
  test.check("global_command is 0", i.global_command == 0);
  test.check("Not done", top->done_o == 0);
